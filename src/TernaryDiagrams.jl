...
Makie.@recipe(TernaryAxis) do scene
    Attributes(
        ...
        xtickwidth = 1f0,
        xtickvisible = true,
        xticklabelsize = @lift($(inherit(scene, :fontsize, 16)) * 0.75),
        ...
        ytickwidth = 1f0,
        ytickvisible = true,
        yticklabelsize = @lift($(inherit(scene, :fontsize, 16)) * 0.75),
        ...
        ztickwidth = 1f0,
        ztickvisible = true,
        zticklabelsize = @lift($(inherit(scene, :fontsize, 16)) * 0.75),
