...
Makie.@recipe(TernaryAxis) do scene
    Attributes(
        ...
        xtickwidth = 1f0,
        xtickvisible = true,
        xticklabelsize = @lift($(inherit(scene, :fontsize, Observable(16))) * 0.75),
        xticklabelfont = inherit(scene, :font, :regular),
        xticklabelcolor = inherit(scene, :textcolor, :red),
        xticklabelrotation = -π/3,
        xticklabelpad = 15f0,
        xticklabelalign = (:left, :center),
        xticklabelvisible = true,
        xarrowcolor = inherit(scene, :color, :black),
        xarrowwidth = inherit(scene, :xspinewidth, 1),
        xlabelsize = @lift($(inherit(scene, :fontsize, Observable(16))) * 0.75),
        xlabelfont = inherit(scene, :font, :regular),
        ...
        xminorgridcolor = inherit(scene, (:Axis, :xgridcolor), RGBAf(0, 0, 0, 0.12)),
        xminorgridvisible = true,
        xspinestyle = :solid,
        xspinewidth = inherit(scene, (:Axis, :xspinewidth), 1),
        xspinecolor = inherit(scene, (:Axis, :xspinecolor), :black),
        xspinevisible = true,
        ...
        ytickalign = 1f0,
        ytickcolor = inherit(scene, (:Axis, :xspinecolor), :black),
        ytickwidth = 1f0,
        ytickvisible = true,
        yticklabelsize = @lift($(inherit(scene, :fontsize, Observable(16))) * 0.75),
        ...
        yarrowcolor = inherit(scene, :color, :black),
        yarrowwidth = inherit(scene, :xspinewidth, 1),
        ylabelsize = @lift($(inherit(scene, :fontsize, Observable(16))) * 0.75),
        ylabelfont = inherit(scene, :font, :regular),
        ...
        yminorgridcolor = inherit(scene, (:Axis, :xgridcolor), RGBAf(0, 0, 0, 0.12)),
        yminorgridvisible = true,
        yspinestyle = :solid,
        yspinewidth = inherit(scene, (:Axis, :xspinewidth), 1),
        yspinecolor = inherit(scene, (:Axis, :xspinecolor), :black),
        yspinevisible = true,
        ...
        ztickalign = 1f0,
        ztickcolor = inherit(scene, (:Axis, :xspinecolor), :black),
        ztickwidth = 1f0,
        ztickvisible = true,
        zticklabelsize = @lift($(inherit(scene, :fontsize, Observable(16))) * 0.75),
        ...
        zarrowcolor = inherit(scene, :color, :black),
        zarrowwidth = inherit(scene, :xspinewidth, 1),
        zlabelsize = @lift($(inherit(scene, :fontsize, Observable(16))) * 0.75),
        zlabelfont = inherit(scene, :font, :regular),
        ...
        zminorgridcolor = inherit(scene, (:Axis, :xgridcolor), RGBAf(0, 0, 0, 0.12)),
        zminorgridvisible = true,
        zspinestyle = :solid,
        zspinewidth = inherit(scene, (:Axis, :xspinewidth), 1),
        zspinecolor = inherit(scene, (:Axis, :xspinecolor), :black),
        zspinevisible = true,
    )
end
